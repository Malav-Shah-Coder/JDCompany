...
class InputFilter extends Singleton
{
	...
	var $ignore_input_names = array ('footer_text','body_end_js', 'body_start_js','head_end_js','head_start_js','body_end_html','body_start_html','body_end_css','body_start_css','head_end_css','head_start_css','about_desc','floor_desc','location_p1','location_p2','projects_amenities_master_ids','location_map','about_heading','about_title','amenities_heading','floor_heading','floor_title','floor_link1','floor_link2','location_heading','location_p1','location_p2','location_map','heading','career_heading','career_desc','job_heading','title','short_desc','ch_title','ch_desc','ch_tag_line','philo_title','philo_desc','chat_code','head_body','description','head_code','body_code');
	...
	function process($source)
	{
		...
		if (is_array($source))
		{
			foreach ($source as $key => $value)
			{
				...
				if (is_string($value))
				{
					if (in_array($key, $this->ignore_input_names))
					{
						$source[$key] = $value;
					}
					else
