<?php
	class model_projects{
		...
		function model_projects($ID=0){
			...
			$this->fields["he_image_alt"]="varchar(255)";
			$this->nullable["he_image_alt"]="NO";
			$this->default_value["he_image_alt"]="";
			$this->fields["image_alt"]="varchar(255)";
			$this->nullable["image_alt"]="NO";
			$this->default_value["image_alt"]="";
			$this->fields["am_image_alt"]="varchar(255)";
			$this->nullable["am_image_alt"]="NO";
			$this->default_value["am_image_alt"]="";
			$this->fields["fl_image_alt"]="varchar(255)";
			$this->nullable["fl_image_alt"]="NO";
			$this->default_value["fl_image_alt"]="";
		}
	}
?>