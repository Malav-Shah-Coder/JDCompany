<?php
	class model_career_detail{
		...
		function model_career_detail($ID=0){
			$this->ID = $ID;
			$this->KEY = "id";
			$this->fields["id"]="int(11)";
			$this->nullable["id"]="NO";
			$this->default_value["id"]="";
			$this->fields["career_page_image"]="varchar(255)";
			$this->nullable["career_page_image"]="NO";
			$this->default_value["career_page_image"]="";
