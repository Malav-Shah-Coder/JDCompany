<?php
	class model_blog{
		...
		function model_blog($ID=0){
			...
			$this->fields["detail_image_alt"]="varchar(255)";
			$this->nullable["detail_image_alt"]="NO";
			$this->default_value["detail_image_alt"]="";
			...
			$this->fields["date_sort_order"]="bigint(20)";
			$this->nullable["date_sort_order"]="NO";
			$this->default_value["date_sort_order"]="";
		}
	}
?>